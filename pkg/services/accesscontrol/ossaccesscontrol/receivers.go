...
func (r ReceiverPermissionsService) DeleteResourcePermissionsByUID(ctx context.Context, orgID int64, uid string) error {
	return r.DeleteResourcePermissions(ctx, orgID, uidToResourceID(uid))
}
